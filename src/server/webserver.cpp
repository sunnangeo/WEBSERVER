...
WebServer::WebServer(int port, int trigMode, int timeoutMS, bool OptLinger,
  ...
  // srcDir_ = "/root/Linux/WEBSERVER/resource/";
  // strcpy(srcDir_, str);
...
void WebServer::DealRead_(HttpConn* client) {
  ...
  threadpool_->submitTask(std::bind(&WebServer::OnRead_, this, client));
...
void WebServer::DealWrite_(HttpConn* client) {
  ...
  threadpool_->submitTask(std::bind(&WebServer::OnWrite_, this, client));
